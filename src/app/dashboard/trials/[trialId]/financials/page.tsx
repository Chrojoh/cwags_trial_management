  ...
  const addExpenseRow = (category?: string) => {
    setExpenses([
      ...expenses,
      {
        ...
        description:
          category === 'Judge Fees'
            ? `Judge ${expenses.filter((e) => e.expense_category === 'Judge Fees').length + 1}`
            : '',
      },
    ]);
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <div
                    className={`text-2xl font-bold ${totals.totalOutstanding > 0 ? 'text-orange-600' : 'text-gray-900'}`}
                  >
              ...
              >
                <CardContent className="pt-6">
                  ...
                  <div
                    className={`text-2xl font-bold ${totals.netIncome >= 0 ? 'text-green-600' : 'text-red-600'}`}
                  >
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    <Button onClick={() => addExpenseRow('Judge Fees')} variant="outline" size="sm">
                  ...
                  {expenses.map((expense, index) => (
                    <div key={index} className="grid grid-cols-12 gap-2 items-center">
                            ...
                            {expense.expense_category === 'Judge Fees' &&
                              ...
                              expense.description && (
                                <div className="text-xs text-blue-600 mt-0.5">
                                  ...
                                  {(
                                    (expense.amount || 0) *
                                    (trialJudges.find((j) => j.name === expense.description)
                                      ?.runsJudged || 0)
                                  ).toFixed(2)}{' '}
                                  total
                                </div>
                      ...
                      <div className="col-span-1">
                        <Button variant="ghost" size="sm" onClick={() => deleteExpense(index)}>
                    ...
                    <div className="flex items-center gap-2 px-2 py-2 bg-blue-50 border border-blue-200 rounded mt-1">
                      ...
                      <div className="flex-1 text-sm text-blue-800">
                        {breakEvenData.regular_cwags_fee > 0 ? (
                          <>
                            C-WAGS Fees — {allRegularRuns} runs × $
                      ...
                      {competitors.map((comp, compIndex) => {
                        ...
                        return (
                          <React.Fragment key={compIndex}>
                            ...
                            >
                              ...
                              >
                                ...
                                {comp.fees_waived && (
                                  <Badge
                                    variant="outline"
                                    className="mt-1 bg-purple-50 text-purple-700 text-xs"
                                  >
                            ...
                            <tr
                              className={`border-b font-semibold ${compIndex % 2 === 0 ? 'bg-orange-100' : 'bg-gray-100'}`}
                            >
                              ...
                              <td className="p-2 text-gray-400"></td>
                              <td
                                className={`p-2 text-right font-mono font-bold text-lg ${
                                  balance > 0
                                    ? 'text-red-600'
                                    : balance < 0
                                      ? 'text-orange-600'
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Estimate how many runs you need to cover your costs
                </p>
              </div>
              <div className="flex space-x-2">
                <Button
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Auto-pulled from your Trial Expenses — these are your known costs before entries
                  are counted. C-WAGS fees are excluded here because they are calculated per run
                  below.
                </CardDescription>
              </CardHeader>
              <CardContent>
                          ...
                          .reduce((sum, e) => {
                            if (e.expense_category === 'Judge Fees' && e.paid_to === 'per_run') {
                              return (
                                sum +
                                (e.amount || 0) *
                                  (trialJudges.find((j) => j.name === e.description)?.runsJudged ||
                                    0)
                              );
                            }
              ...
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  <span className="text-blue-600 font-medium">
                    {' '}
                    The C-WAGS fee you enter here also drives the auto-calculated C-WAGS expense
                    line on the Expenses & Payments tab.
                  </span>
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setBreakEvenData({
                            ...breakEvenData,
                            regular_entry_fee: parseFloat(e.target.value) || 0,
                          })
                        }
                        className="pl-7"
                      />
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setBreakEvenData({
                            ...breakEvenData,
                            regular_cwags_fee: parseFloat(e.target.value) || 0,
                          })
                        }
                        className="pl-7"
                      />
                ...
                {breakEvenData.regular_entry_fee > 0 && (
                  <div className="mt-4 p-3 bg-gray-50 rounded border text-sm">
                    ...
                    <span className="font-semibold">
                      ${breakEvenData.regular_entry_fee.toFixed(2)} entry − $
                      {breakEvenData.regular_cwags_fee.toFixed(2)} C-WAGS =
                    </span>
                    <span className="font-bold text-green-700 ml-1">
                      $
                      {(breakEvenData.regular_entry_fee - breakEvenData.regular_cwags_fee).toFixed(
                        2
                      )}
                    </span>
                  </div>
                  ...
                  const fixedCosts = expenses.reduce((sum, e) => {
                    if (e.expense_category === 'Judge Fees' && e.paid_to === 'per_run') {
                      return (
                        sum +
                        (e.amount || 0) *
                          (trialJudges.find((j) => j.name === e.description)?.runsJudged || 0)
                      );
                    }
                    if (e.paid_to === 'waived') return sum;
                    return sum + (e.amount || 0);
                  ...
                  return (
                    <div className="space-y-4">
                      ...
                      <div className="bg-gray-50 rounded p-4 space-y-2 text-sm font-mono">
                        ...
                        <div className="flex justify-between">
                          <span className="text-gray-600">
                            ÷ Net per paid run (${breakEvenData.regular_entry_fee.toFixed(2)} − $
                            {breakEvenData.regular_cwags_fee.toFixed(2)}):
                          </span>
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center">
                        ...
                        <div
                          className={`p-3 rounded border ${isProfitable ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}
                        >
                          <div
                          ...
                          <div
                            className={`text-2xl font-bold ${isProfitable ? 'text-green-700' : 'text-red-700'}`}
                          >
                        ...
                        <div>
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-3">
                            <div
                              ...
                              style={{
                                width: `${Math.min(100, (totalPaidRuns / breakEvenRuns) * 100)}%`,
                              }}
                            />
                          </div>
                        </div>
        ...
        <Dialog open={showPaymentModal} onOpenChange={setShowPaymentModal}>
          <DialogContent className="bg-white">
            ...
            <div className="space-y-4">
              {selectedCompetitor?.payment_history &&
                selectedCompetitor.payment_history.length > 0 && (
              ...
              <div>
                <Label>
                  ...
                  {selectedCompetitor?.fees_waived
                    ? '0.00'
                    : (selectedCompetitor?.amount_owed || 0).toFixed(2)}
                </Label>
                <Label>Already Paid: ${(selectedCompetitor?.amount_paid || 0).toFixed(2)}</Label>
                <Label>
                  Remaining: $
                  {(
                    (selectedCompetitor?.fees_waived ? 0 : selectedCompetitor?.amount_owed || 0) -
                    (selectedCompetitor?.amount_paid || 0)
                  ).toFixed(2)}
                </Label>
              </div>
        ...
        <Dialog open={showEditPaymentModal} onOpenChange={setShowEditPaymentModal}>
          <DialogContent className="bg-white">
            <DialogHeader>
              ...
              <DialogDescription>Correct the payment details</DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <Alert>
                <AlertCircle className="h-4 w-4" />
            ...
            <div className="space-y-4">
              <Alert className="bg-purple-50 border-purple-200">
                ...
                <AlertDescription className="text-purple-800">
                  ...
                  {selectedCompetitor &&
                    (() => {
                      const effectiveOwed = selectedCompetitor.fees_waived
                        ? 0
          ...
          <DialogContent className="bg-white">
            ...
            <div className="space-y-4">
              <Alert>
                <AlertCircle className="h-4 w-4" />
                <AlertDescription>
                  This will set the amount owed to $0. Common reasons: volunteering, working for
                  entries, club member discount.
                </AlertDescription>
              </Alert>
