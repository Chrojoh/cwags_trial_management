-- Forward-only Journal 2 patch.
-- Adds emergency-contact changes to entry edit auditing. This replaces only
-- the trigger function body; it does not backfill or update existing rows.
